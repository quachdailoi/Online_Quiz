...
import loiqd.quizuser.QuizUserDTO;
...
public class HistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        QuizUserDAO dao = new QuizUserDAO();
        ArrayList<QuizUserDTO> listHistory = new ArrayList<>();
        try{
            listHistory = dao.getHistory(email);
            System.out.println("sizze: " + listHistory.size());
        ...
        String url = FilterSupport.getUrl(request, "history_page");
